...
def napari_experimental_provide_dock_widget():
    ...
    from ._object_custom_classifier import LabelClassificationWidget
    return [ObjectSegmentation, SemanticSegmentation, Train_object_classifier, LabelClassificationWidget]
